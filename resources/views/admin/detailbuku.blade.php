                        ...
                        <div class="card-header ">
                            <div class="row form-inline">
                                ...
                                <div class="col-md-8 ">
                                    ...
                                    <a href="{{route('admin.buku.editbuku',['id'=>  $buku->kode_buku])}}"
                                       class="btn btn-out btn-fill btn-success pull-right"><i class="fa fa-pencil"></i>
                                        Edit Buku</a>
                                </div>
