                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group" >
                                                ...
                                                <textarea type="text" style="border-radius: 0px; height: 192px"  name="abstrak" class="form-control">{{$buku->abstrak}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group" >
                                                ...
                                                <input type="number" style="border-radius: 0px" name="harga_beli" class="form-control" value="{{$buku->harga_beli}}">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group" >
