                                ...
                                <div class="col-md-12 ">
                                    <div class="row">
                                        <div class="col-md-10" style="padding-right: 0">
                                            <form action="{{route('klasifikasi')}}" method="GET">
                                                {{csrf_field()}}
                                                ...
                                                <input type="text" name="keyword" placeholder="Cari berdasarkan nama atau prefix klasifikasi" class="form-control" style="width: 90%">
                                            </form>
                                        </div>
