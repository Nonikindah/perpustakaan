                            ...
                            <form method="POST" action="{{route('datamaster.tambah')}}">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Prefix</label>
                                            <input type="text" class="form-control" name="prefix" value="{{ old('prefix') }}" required autofocus>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="" class="form-control" name="keterangan" value="{{ old('keterangan') }}" required></textarea>
                                        </div>
                                    </div>
                                </div>
