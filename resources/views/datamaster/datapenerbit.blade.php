                    ...
                    <div class="card strpied-tabled-with-hover">
                        <div class="card-header ">
                            <div class="row form-inline">
                                <h4 class="col-md-12 card-title"><b>Data Penerbit</b><hr></h4>
                                ...
                                <div class="col-md-12 ">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2" style="padding-left: 0">
                                            <a href="{{route('datamaster.tambahpenerbit')}}" class="btn btn-primary btn-fill pull-right" ><i class="fa fa-plus"></i> Tambah Penerbit</a>
                                        </div>
                                    </div>
                                </div>
