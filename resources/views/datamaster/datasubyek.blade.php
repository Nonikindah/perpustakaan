                                ...
                                <div class="col-md-12 ">
                                    <div class="row">
                                        <div class="col-md-10" style="padding-right: 0">
                                            <form action="{{route('datamaster.searchsubyek')}}" method="GET">
                                                {{csrf_field()}}
                                                ...
                                                <input type="text" name="id" placeholder="Cari berdasarkan nama subyek" class="form-control" style="width: 90%">
                                            </form>
                                        </div>
